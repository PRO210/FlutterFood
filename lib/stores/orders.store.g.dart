...
mixin _$OrdersStore on _OrdersStoreBase, Store {
  final _$insMakingOrderAtom = Atom(name: '_OrdersStoreBase.insMakingOrder');

  @override
  bool get insMakingOrder {
    _$insMakingOrderAtom.reportRead();
    return super.insMakingOrder;
  }

  @override
  set insMakingOrder(bool value) {
    _$insMakingOrderAtom.reportWrite(value, super.insMakingOrder, () {
      super.insMakingOrder = value;
    });
  }
